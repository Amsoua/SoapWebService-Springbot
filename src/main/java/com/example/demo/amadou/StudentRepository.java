package com.example.demo.amadou;
...
import com.demo.xml.school.Student;
...
public class StudentRepository {
	...
	public void initData() {
		...
		student = new Student();
		student.setName("Amadou");
		student.setStandard(10);
		student.setAddress("PAU7");
		students.put(student.getName(), student);

		student = new Student();
		student.setName("Mohamet");
		student.setStandard(11);
		student.setAddress("Keur Ndiaye LO");
		students.put(student.getName(), student);
